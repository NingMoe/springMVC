...
!function($){
	...
	$.load=function(){
		...
		$._isload =1;
		var d = $.confirm.call($,arguments[0]||"提交中，请稍后...");
		$.loaded = d.close;
		return d;
	}
}($)